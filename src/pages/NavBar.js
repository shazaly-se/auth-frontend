                            ...
                            <ul class="navbar-nav">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div>
                                                    ...
                                                    <a href="ui-image-cropper.html" class="dropdown-item" key="t-image-cropper">Image Cropper</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-components">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="topnav-charts">
                                                ...
                                                <a href="charts-chartjs.html" class="dropdown-item" key="t-chartjs-chart">Chartjs Chart</a>
                                                <a href="charts-flot.html" class="dropdown-item" key="t-flot-chart">Flot Chart</a>
                                                <a href="charts-tui.html" class="dropdown-item" key="t-ui-chart">Toast UI Chart</a>
                                                <a href="charts-knob.html" class="dropdown-item" key="t-knob-chart">Jquery Knob Chart</a>
                                                <a href="charts-sparkline.html" class="dropdown-item" key="t-sparkline-chart">Sparkline Chart</a>
                                            </div>
                                        </div>
                                        <div class="dropdown">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="topnav-layout">
                                        <a href="layouts-vertical.html" class="dropdown-item" key="t-vertical">Vertical</a>
